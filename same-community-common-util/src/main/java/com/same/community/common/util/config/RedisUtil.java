...
public class RedisUtil {
    ...
    public Set<ZSetOperations.TypedTuple<Object>> getAllFromZSetAsc(String key) {
        try {
    ...
    public Set<ZSetOperations.TypedTuple<Object>> getAllFromZSetDesc(String key) {
        try {
    ...
    public boolean zSetAddIfAbsent(String key1, String key2, double value) {
        try {
            return Boolean.TRUE.equals(redisTemplate.opsForZSet().addIfAbsent(key1, key2, value));
        } catch (Exception e) {
            log.error("redis操作异常", e);
            return false;
        }
    ...
    public Double zSetIncrement(String key1, String key2, double value) {
        try {
